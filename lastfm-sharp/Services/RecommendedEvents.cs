...
namespace Lastfm.Services
{
    public class RecommendedEvents : Pages<Event>
    {
        ...
        public RecommendedEvents(AuthenticatedUser user, Session session) : base("user.getRecommendedEvents", session)
        {
            User = user;
        }
        ...
        public override Event[] GetPage(int page)
        {
            ...
            XmlDocument doc = Request("user.getRecommendedEvents", parameters);
