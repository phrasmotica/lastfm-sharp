...
{
    /// <summary> A unique radio station URI. They are in the form of
    /// lastfm://<stationtype>/<resourcename>/<station-subtype> </summary>
    public class StationURI
    {
        ...
        {
            return $"lastfm://{StationType}/{ResourceName}/{SubType}";
        }
